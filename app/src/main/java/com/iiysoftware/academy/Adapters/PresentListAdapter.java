...
public class PresentListAdapter extends FirestoreRecyclerAdapter<Drivers, PresentListAdapter.ViewHolder> {
    ...
    public PresentListAdapter(Context mContext, FirestoreRecyclerOptions<Drivers> options) {
        super(options);
