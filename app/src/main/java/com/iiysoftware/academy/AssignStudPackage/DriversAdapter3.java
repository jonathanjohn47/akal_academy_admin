...
public class DriversAdapter3 extends FirestoreRecyclerAdapter<Drivers, DriversAdapter3.ViewHolder> {
    ...
    public DriversAdapter3(Context mContext, FirestoreRecyclerOptions<Drivers> options) {
        super(options);
    ...
    protected void onBindViewHolder(@NonNull final ViewHolder holder, final int position, @NonNull final Drivers model) {
        ...
        holder.assign.setText("Assign Students");
